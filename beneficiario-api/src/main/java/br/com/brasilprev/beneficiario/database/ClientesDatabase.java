package br.com.brasilprev.beneficiario.database;
...
import br.com.brasilprev.banco.database.LocalDatabase;
...
public class ClientesDatabase implements Closeable {
    ...
    public ClientesDatabase() throws SQLException {
        ...
        this.database.createIfNotExists("create table new_cliente (" +
    ...
    public boolean saveNew(Cliente cliente) throws SQLException {
        ...
        database.update("insert into new_cliente (cpf) values (?)", cliente.getCpf());
        return true;
    }
